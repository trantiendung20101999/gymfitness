...
public class ItemGymExerciseAdapterRe extends RecyclerView.Adapter<ItemGymExerciseHolder> {

    private Context mContext;
    private ArrayList<SectionGymExercise> sectionGymExerciseArrayList;

    public ItemGymExerciseAdapterRe(Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ItemGymExerciseHolder holder, int position) {
        ...
        GymExerciseAdapterRe adapter = new GymExerciseAdapterRe(mContext);
